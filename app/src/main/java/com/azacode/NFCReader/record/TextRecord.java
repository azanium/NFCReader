 ...
 * the License.
 */
package com.azacode.NFCReader.record;
...
import com.azacode.NFCReader.R;
...
public class TextRecord implements ParsedNdefRecord {
    ...
    public View getView(Activity activity, LayoutInflater inflater, ViewGroup parent, int offset) {
        ...
        String output = "";
        try {
            JSONObject json = new JSONObject(mText);
            ...
            output += "Security On Duty: " + security + "\n";
            output += "Klien: " + client + "\n";
            output += "Lokasi: " + location + "\n";
            output += "Gedung: " + building + "\n";
            output += "Lantai: " + floor + "\n";
            output += "Waktu: " + time + "\n";
        }
